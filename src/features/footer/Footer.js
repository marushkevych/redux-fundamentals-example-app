...
import { selectUncompletedTodos, allCompleted, completedCleared } from '../todos/todosSlice'
...
const Footer = () => {
  ...
  const markAllCompleted = () => dispatch(allCompleted())
  ...
  return (
      <footer className="footer">
        ...
        <RemainingTodos count={uncompletedTodos.length} />
